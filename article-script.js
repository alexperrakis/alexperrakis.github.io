function getMediumFeed() {
    ...
    fetch("https://api.rss2json.com/v1/api.json?rss_url=https://medium.com/feed/@alexperrakis", requestOptions)
                        ...
                        <a target="_blank" href="${link}">
                            <div class="project-box">
                                <div class="body">
                                    ...
                                    <div class="article-img" style="background: var(--box-color) url(${imageURL}) center bottom no-repeat; background-size: 400px"></div>
